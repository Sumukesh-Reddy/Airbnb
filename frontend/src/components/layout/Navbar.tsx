      ...
      <header className="sticky top-0 z-40 bg-white border-b border-gray-200">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            {/* Center Navigation Tabs (Image 2 style) */}
            {isHome ? (
              <div className="hidden md:flex items-center gap-8 text-sm font-medium">
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-emerald-100/60 flex items-center justify-center text-base">
                    🏡
                  </div>
                  <span>Homes</span>
                  {activeTab === 'homes' && (
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-rose-100/60 flex items-center justify-center text-base">
                    🎈
                  </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                ...
                className="hidden md:flex items-center text-sm font-semibold text-gray-800 
                  hover:bg-gray-100 px-4 py-2.5 rounded-full transition-all"
              >
                Switch to hosting
              </Link>

              {/* Currency Button (Circle $) */}
              <button className="hidden md:flex items-center justify-center w-9 h-9 rounded-full bg-amber-100/70 text-gray-800 text-sm font-semibold hover:bg-amber-200/70 transition-colors">
                $
              </button>
              ...
              <div ref={menuRef} className="relative">
                <button
                  ...
                  className="flex items-center gap-3 border border-gray-300 rounded-full px-3 py-1.5
                ...
                {showUserMenu && (
                  <div className="absolute right-0 top-full mt-2 bg-white rounded-2xl shadow-xl border border-gray-100 
                    ...
                    {user ? (
                      ...
                      <>
                        <button
                          onClick={() => { setShowUserMenu(false); openLogin(); }}
                          className="w-full flex items-center px-4 py-3 font-semibold text-gray-900 hover:bg-gray-50 transition-colors text-left"
                        >
                          Log in
                        </button>
                        <button
                          onClick={() => { setShowUserMenu(false); openRegister(); }}
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-between px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors text-left"
                        >
