...
export const MOCK_LISTINGS_FULL: ListingDetail[] = [
  ...
  {
    id: 4,
    title: 'Luxury Treehouse Sanctuary in Coorg',
    description: 'Surrounded by lush coffee plantations and ancient rain trees, this eco-luxury treehouse offers a unique canopy view.',
    ...
    images: [
      { id: 20, url: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800', is_primary: true, display_order: 1 },
      { id: 21, url: 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=800', is_primary: false, display_order: 2 },
    ],
    amenities: [{ id: 1, name: 'WiFi', icon: 'wifi' }],
  },
  {
    id: 5,
    title: 'Traditional Backwater Houseboat in Alleppey',
    description: 'Glide gently along the tranquil Vembanad Lake in a traditional wooden houseboat with modern luxury bedrooms and private chef.',
    ...
    images: [
      { id: 22, url: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800', is_primary: true, display_order: 1 },
    ],
    amenities: [{ id: 1, name: 'WiFi', icon: 'wifi' }],
  },
  {
    id: 6,
    title: '300-Year-Old Royal Heritage Haveli',
    description: 'Live like royalty in a meticulously restored Rajput palace featuring courtyard fountains, intricate jharokha balconies, and rooftop dining.',
    ...
    images: [
      { id: 23, url: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800', is_primary: true, display_order: 1 },
    ],
    amenities: [{ id: 1, name: 'WiFi', icon: 'wifi' }],
  },
  {
    id: 7,
    title: 'Organic Farm Stay in Punjab Countryside',
    description: 'Experience authentic Punjabi hospitality surrounded by lush mustard fields, fresh dairy, chulha cooking, and serene star-filled night skies.',
    ...
    images: [
      { id: 24, url: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800', is_primary: true, display_order: 1 },
    ],
    amenities: [{ id: 1, name: 'WiFi', icon: 'wifi' }],
  },
  {
    id: 8,
    title: 'Modern Minimalist Studio Loft in Bandra',
    description: 'Chic designer studio loft in the heart of Mumbai’s trendy Bandra West. Walking distance to hip cafes, boutiques, and Carter Road promenade.',
    ...
    images: [
      { id: 25, url: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800', is_primary: true, display_order: 1 },
    ],
    amenities: [{ id: 1, name: 'WiFi', icon: 'wifi' }],
  },
];
